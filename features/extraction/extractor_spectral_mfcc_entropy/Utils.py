...
def write_arff(songs_array, path):
    ...
    s += "@ATTRIBUTE MEAN_CENTR" + " NUMERIC\n"
    s += "@ATTRIBUTE STD_CENTR" + " NUMERIC\n"
    s += "@ATTRIBUTE MEAN_ROLL" + " NUMERIC\n"
    s += "@ATTRIBUTE STD_ROLL" + " NUMERIC\n"
    s += "@ATTRIBUTE MEAN_FLUX" + " NUMERIC\n"
    s += "@ATTRIBUTE STD_FLUX" + " NUMERIC\n"
...
def write_spectral_arff(songs_array, path):
    # header composition
    s = "@RELATION spectral_features\n"
    s += "@ATTRIBUTE MEAN_CENTR" + " NUMERIC\n"
    s += "@ATTRIBUTE STD_CENTR" + " NUMERIC\n"
    s += "@ATTRIBUTE MEAN_ROLL" + " NUMERIC\n"
    s += "@ATTRIBUTE STD_ROLL" + " NUMERIC\n"
